...
import Operation from "@api-platform/api-doc-parser/lib/Operation";
import fetchJsonLd from "@api-platform/api-doc-parser/lib/hydra/fetchJsonLd";
import getParameters from "@api-platform/api-doc-parser/lib/hydra/getParameters";
  ...
  return fetchEntrypointAndDocs(entrypointUrl, options).then(
    ({ entrypoint, docs, response }) => {
      ...
      for (const properties of entrypointClass[
        ...
        // if(typeof console === 'object') { console.log('relatedClass',relatedClass); }
        ...
        const resource = new Resource(
          ...
          url,
          {
            ...
            title: get(
              ...
              menuGroup: get(
                  relatedClass,
                  '["local:menuGroup"][0]["@value"]',
                  ""
              ),
              showInMenu: get(
                  relatedClass,
                  '["local:showInMenu"][0]["@value"]',
                  ""
              ),
